...
public class NamedCSVMethodMapper extends AbstractMapper<MethodEntry> {
    ...
    protected NamedCSVMethodMapper(MappingProvider intermediary, File file, int headerRow, int classColumn, int methodColumn, int mappedColumn, int javaDocColumn, PackageRelocation relocator) {
